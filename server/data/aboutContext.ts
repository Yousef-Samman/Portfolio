...
export function formatAboutContext(): string {
  ...
  lines.push(
    ...
    '- Critical: this ChatBot IS the Portfolio (this site) assistant you built. Questions like "How did you build this site\'s AI assistant?", "How does this ChatBot work?", or "Did you build you?" must be answered from Portfolio (this site) facts — React/TypeScript/Vite/Tailwind, Express, Claude Haiku (claude-haiku-4-5-20251001), context-injection grounding (not RAG), max_tokens 500, per-IP and global rate limits, Turnstile, Resend, Vercel/Render. First person: I built this stack. Never deny authorship, never claim a third party built the assistant, and never answer that question with HackathonHub.',
